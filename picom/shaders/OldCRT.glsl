...
const float sc_freq = 0.2; // Frequency for the scanlines

const float sc_intensity = 0.6; // Intensity of the scanline effect

const bool grid = false; // Whether to also apply scanlines to x axis or not

const int distortion_offset = 2; // Pixel offset for red/blue distortion

const int downscale_factor = 2; // How many pixels of the window
                                  // make an actual "pixel" (or block)

const float sph_distance = 500; // Distance from the theoretical sphere 
                                  // we use for our curvature transform

const float curvature = 1.5; // How much the window should "curve" 
...
const int shadow_intensity = 1; // Intensity level of the shadow effect (from 1 to 5)
